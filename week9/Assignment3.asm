...
.text   
main:   jal     UNTRACK           # don't track line 
        nop 
...
goDOWN: addi  $a0, $zero, 180   # Marsbot rotates 90*   
        jal   ROTATE 
        nop 
...
goRIGHT1:addi  $a0, $zero, 90   # Marsbot rotates 90*   
        jal   ROTATE     
        nop 
...
goASKEW1:addi  $a0, $zero, 315   # Marsbot rotates 315*   
        jal   ROTATE     
        nop     
        
sleep5: addi    $v0,$zero,32    # Keep running by sleeping in 5000 ms       
        li      $a0,5200         
        syscall     
